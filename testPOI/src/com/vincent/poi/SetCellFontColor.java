...
public class SetCellFontColor {
	...
	public static void main(String[] args) {
		...
		RichTextString str = helper.createRichTextString("abcde");// 在这里使用\n表示回车
		...
		/*for (int i = 0; i < 5; i++) {
			str.applyFont(i * 2, (i + 1) * 2, fonts[0]);
		}*/
		str.applyFont(fonts[0]);
		
		cell.setCellValue(str);
		try {
			FileOutputStream out = new FileOutputStream(new File("setcellfontcolor.xls"));
			workbook.write(out);
			out.close();
